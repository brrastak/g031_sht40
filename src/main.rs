...
use epd_waveshare::{epd1in02, prelude::*};
use fixed::types::*;
// use hal::{
//     clocks::Clock,
//     fugit::RateExtU32,
...
mod app {
    ...
    type SpiDev = ExclusiveDevice<spi::SpiBus<hal::pac::SPI1, (gpioa::PA5<hal::gpio::Analog>, spi::NoMiso, gpioa::PA7<hal::gpio::Analog>)>, gpioa::PA<Output<PushPull>>, &'static mut hal::timer::delay::Delay<hal::pac::TIM17>>;
    type Epd = epd1in02::Epd1in02<ExclusiveDevice<spi::SpiBus<hal::pac::SPI1, (gpioa::PA5<hal::gpio::Analog>, spi::NoMiso, gpioa::PA7<hal::gpio::Analog>)>, gpioa::PA<Output<PushPull>>, &'static mut hal::timer::delay::Delay<hal::pac::TIM17>>, gpioa::PA<hal::gpio::Input<hal::gpio::Floating>>, gpioa::PA<Output<PushPull>>, gpioa::PA<Output<PushPull>>, hal::timer::delay::Delay<hal::pac::TIM16>>;
    type Sensor = sht4x::Sht4x<hal::i2c::I2c<hal::pac::I2C1, hal::gpio::PB7<Output<hal::gpio::OpenDrain>>, hal::gpio::PB6<Output<hal::gpio::OpenDrain>>>, hal::timer::delay::Delay<hal::pac::TIM14>>;
    ...
    struct Local {
        epd: Epd,
        spi_dev: SpiDev,
        epd_delay: hal::timer::delay::Delay<hal::pac::TIM16>,
        // rtc: rtc::RealTimeClock,
        sensor: Sensor,
        sensor_delay: hal::timer::delay::Delay<hal::pac::TIM14>,
        en_sensor: InvertedPin<gpioa::PA<Output<PushPull>>>,
    }
    ...
    fn init(cx: init::Context) -> (Shared, Local) {
        ...
        let mut epd = epd1in02::Epd1in02::new(
            &mut spi_dev,
            epd_busy,
            epd_dc,
            epd_reset,
        ...
        // Sht40 sensor
        let en_sensor = gpioa.pa12.into_push_pull_output().downgrade();
    ...
    #[task(local = [epd, spi_dev, epd_delay, sensor, sensor_delay, en_sensor], priority = 1)]
    async fn main_task(cx: main_task::Context) {

        let main_task::LocalResources
            {epd, spi_dev, epd_delay, sensor, sensor_delay, en_sensor, ..} = cx.local;


        let mut frame = epd1in02::Display1in02::default();
        frame.set_rotation(DisplayRotation::Rotate0);
